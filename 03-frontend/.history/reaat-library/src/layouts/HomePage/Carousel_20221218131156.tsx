        ...
        <div className="container mt-5" style={{ height: 550 }}>
            ...
            <div id="carouselExampleControls" className="carousel carousel-dark slide mt-5 d-none d-lg-block" data-bs-interval='false'>
                ...
                <button className='carousel-control-prev' type="button" data-bs-target='#carouselExampleControls' data-bs-slide='prev'>
                    <span className='carousel-control-pre-icon' aria-hidden='true'></span>
                    <span className='visually-hidden'>Previous</span>
                </button>
                <button className='carousel-control-prev' type="button" data-bs-target='#carouselExampleControls' data-bs-slide='next'>
